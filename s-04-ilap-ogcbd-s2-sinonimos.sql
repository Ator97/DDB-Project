...
--@Descripción: Creación de sinónimos en Sitio SO
...
create or replace synonym sucursal_f4 for sucursal_f4_ogc_s2;
...
create or replace synonym sucursal_venta_f4 for sucursal_venta_f4_ogc_s2;
...
create or replace synonym sucursal_taller_f4 for sucursal_taller_f4_ogc_s2;

--laptop
create or replace synonym laptop_f1 for laptop_f1_ogc_s2;
create or replace synonym laptop_f2 for laptop_f2_elv_s1@elvbd_s1.fi.unam;
create or replace synonym laptop_f3 for laptop_f3_ogc_s2;
...
create or replace synonym servicio_laptop_f2 for servicio_laptop_f2_ogc_s2;
...
create or replace synonym tipo_monitor_r4 for tipo_monitor_r_ogc_s2;
...
create or replace synonym tipo_almacenamiento_r4 for tipo_almacenamiento_r_ogc_s2;
...
create or replace synonym tipo_procesador_r4 for tipo_procesador_r_ogc_s2;
...
create or replace synonym tipo_tarjeta_video_r4 for tipo_tarjeta_video_r_ogc_s2;
