...
--@Descripción: Creación de sinónimos en Sitio EA

--sucursal
create or replace synonym sucursal_f1 for sucursal_f1_elv_s1@elvbd_s1.fi.unam;
create or replace synonym sucursal_f2 for sucursal_f2_elv_s2;
...
create or replace synonym sucursal_venta_f2 for sucursal_venta_f2_elv_s2;
...
create or replace synonym sucursal_taller_f2 for sucursal_taller_f2_elv_s2;
...
create or replace synonym laptop_f5 for laptop_f5_elv_s2;
...
--historico
create or replace synonym historico_status_laptop_f1 for historico_f1_elv_s2;
...
create or replace synonym servicio_laptop_f4 for servicio_laptop_f4_elv_s2;

--tipo_monitor
create or replace synonym tipo_monitor_r1 for tipo_monitor_r_elv_s1@elvbd_s1.fi.unam;
create or replace synonym tipo_monitor_r2 for tipo_monitor_r_elv_s2;
...
create or replace synonym tipo_almacenamiento_r2 for tipo_almacenamiento_r_elv_s2;
...
create or replace synonym tipo_procesador_r2 for tipo_procesador_r_elv_s2;
...
create or replace synonym tipo_tarjeta_video_r2 for tipo_tarjeta_video_r_elv_s2;
